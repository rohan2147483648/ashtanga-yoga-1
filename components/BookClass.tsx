...
export default function BookClass() {
  ...
  const x1 = useTransform(scrollYProgress, [0, 1], ["-22%", "22%"]);
  // Row 2 → drifts right-to-left (italic accent)
  const x2 = useTransform(scrollYProgress, [0, 1], ["22%", "-22%"]);
    ...
    >
      ...
      <div className="sticky top-0 h-screen flex flex-col items-center justify-center px-2">
        ...
        <div className="w-full overflow-hidden">
          ...
          >
            <h2 className="font-serif text-[14vw] md:text-[12vw] leading-none text-stone-900 whitespace-nowrap tracking-tight">
